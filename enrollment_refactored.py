"""
Refactored Student Enrollment backend.

Goal:
- Separate database work from service/business logic
- Keep config/constants separate
- Keep seed/setup logic separate
- Keep snapshot/export logic separate
- Keep main runner as simple orchestration
"""
...
class EnrollmentDatabase:
    """Handles database connection, table setup, and direct SQL queries."""
    ...
    def get_student_enrollment_records(
        self,
        user_id: str,
    ) -> list[dict[str, Any]]:
        with self.connect() as connection:
...
class EnrollmentService:
    """Handles enrollment rules and student-facing behavior."""
    ...
    def get_course_by_key(
        ...
        return self.database.get_course_by_key(clean_key)
    ...
    def get_student_enrollments(
        ...
        records = self.database.get_student_enrollment_records(user_id)
    ...
    def get_student_enrollment_history(
        ...
        return self.database.get_student_enrollment_records(user_id)
...
class SnapshotExporter:
    """Handles creating and writing the JSON database snapshot."""
...
def main() -> None:
    ...
    exporter = SnapshotExporter(database, service)
    ...
    exporter.export_database_snapshot(CURRENT_STUDENT)
